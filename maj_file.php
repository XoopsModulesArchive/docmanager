<?php
// $Id: maj_file.php,v 1.4 2005/03/14 20:05:43 jsaucier Exp $
//  ------------------------------------------------------------------------ //
//                           Document Manager                                //
...
// Set the template
$xoopsOption['template_main'] = 'docmanager_majfile.html';    
...
// Test if the file exist in the current dir, if we have the right to access it, if we can modify the file and if the folder is not hidden
...
// Set langage options
$xoopsTpl->assign('docmanager_title', _MD_DOCMANAGER_MAJFILE);
$xoopsTpl->assign('docmanager_majfile_name', _MD_MAJFILE_NAME);
$xoopsTpl->assign('docmanager_majfile_submit', _MD_MAJFILE_SUBMIT);
$xoopsTpl->assign('docmanager_majfile_cancel', _MD_MAJFILE_CANCEL);
