...
// Set the template
$xoopsOption['template_main'] = 'docmanager_createfolder.html';    
...
// Set langage options
$xoopsTpl->assign('docmanager_title', _MD_DOCMANAGER_CREATEFOLDER);
$xoopsTpl->assign('docmanager_folder_name', $myrow['folders_name']);
$xoopsTpl->assign('docmanager_createfolder_name', _MD_CREATEFOLDER_NAME);
$xoopsTpl->assign('docmanager_createfolder_submit', _MD_CREATEFOLDER_SUBMIT);
$xoopsTpl->assign('docmanager_createfolder_cancel', _MD_CREATEFOLDER_CANCEL);
