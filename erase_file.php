...
// Set the template
$xoopsOption['template_main'] = 'docmanager_erasefile.html';    
...
// Set langage options
$xoopsTpl->assign('docmanager_title', _MD_DOCMANAGER_ERASEFILE);
$xoopsTpl->assign('docmanager_file_name', $myrow['files_name']);
$xoopsTpl->assign('docmanager_erasefile_confirm', _MD_ERASEFILE_CONFIRM);
$xoopsTpl->assign('docmanager_erasefile_submit', _MD_ERASEFILE_SUBMIT);
$xoopsTpl->assign('docmanager_erasefile_cancel', _MD_ERASEFILE_CANCEL);
